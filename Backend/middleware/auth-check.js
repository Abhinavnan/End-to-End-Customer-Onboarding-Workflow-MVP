...
const authCheck = (req, res, next) => {
    ...
    try {
        ...
        decodedToken = jwt.verify(token, process.env.JWT_SECRET); //verify the token with the secret key
    ...
    req.userData = {email: decodedToken.email}; //set the user data in the request object
